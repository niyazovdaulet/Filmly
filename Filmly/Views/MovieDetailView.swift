...
//        print("MovieDetailView: init for movie \(movie.id)")
    ...
    var body: some View {
        GeometryReader { geometry in
                    ...
                    VStack(alignment: .leading, spacing: 28) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            VStack(spacing: 12) {
                                ...
                                DetailRow(title: "Popularity", value: String(format: "%.1f", movie.popularity))
                            }
                        }
                        .padding(.horizontal, 20)
                        ...
                        if !detailService.recommendations.isEmpty {
                            MovieCarouselSection(title: "Recommended Movies", movies: detailService.recommendations, onSelect: { _ in })
                        } else {
                        ...
                        if !detailService.similarMovies.isEmpty {
                            MovieCarouselSection(title: "Similar Movies", movies: detailService.similarMovies, onSelect: { _ in })
                        } else {
            ...
            .onAppear {
//                print("MovieDetailView: onAppear for movie \(movie.id)")
